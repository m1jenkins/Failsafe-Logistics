...
const testimonials: TestimonialData[] = [
  {
    ...
    quote: "We had an AOG (Aircraft on Ground) situation. FailSafe got the part from Dallas in 3 hours flat. Saved us $50k in delays."
  },
  {
  ...
  },
  {
    ...
    quote: "When transplant teams need samples, we don't call Uber. We call FailSafe. Professional, sterile, and ridiculously fast."
  }
];
  ...
  return (
    <section className="py-24 bg-slate-950 border-t border-slate-800">
      <div className="container mx-auto px-4">
        <SectionHeading title="Client Reviews" subtitle="When failure is not an option, professionals choose FailSafe." />
